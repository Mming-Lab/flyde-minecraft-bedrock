...
export const OnItemInteracted: CodeNode = {
  ...
  description: 'プレイヤーがアイテムを使用したとき発火する',
  icon: 'bolt',
  defaultStyle: STYLE,
  completionOutputs: [],
  inputs: {
...
export const OnItemAcquired: CodeNode = {
  ...
  description: 'プレイヤーがアイテムを取得したとき発火する',
  icon: 'bolt',
  defaultStyle: STYLE,
  completionOutputs: [],
  inputs: {
...
export const OnItemCrafted: CodeNode = {
  ...
  description: 'プレイヤーがアイテムをクラフトしたとき発火する',
  icon: 'bolt',
  defaultStyle: STYLE,
  completionOutputs: [],
  inputs: {
...
export const OnItemEquipped: CodeNode = {
  ...
  description: 'プレイヤーがアイテムを装備したとき発火する',
  icon: 'bolt',
  defaultStyle: STYLE,
  completionOutputs: [],
  inputs: {
...
export const OnItemSmelted: CodeNode = {
  ...
  description: 'プレイヤーがアイテムを精錬したとき発火する',
  icon: 'bolt',
  defaultStyle: STYLE,
  completionOutputs: [],
  inputs: {
