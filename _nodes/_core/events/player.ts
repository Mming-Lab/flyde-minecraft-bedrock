...
export const OnPlayerChat: CodeNode = {
  ...
  description: 'プレイヤーがチャットを送信したとき発火する',
  icon: 'bolt',
  defaultStyle: STYLE,
  completionOutputs: [],
  inputs: {
...
export const OnPlayerJoin: CodeNode = {
  ...
  description: 'プレイヤーがワールドに参加したとき発火する',
  icon: 'bolt',
  defaultStyle: STYLE,
  completionOutputs: [],
  inputs: {
...
export const OnPlayerLeave: CodeNode = {
  ...
  description: 'プレイヤーがワールドを退出したとき発火する',
  icon: 'bolt',
  defaultStyle: STYLE,
  completionOutputs: [],
  inputs: {
...
export const OnPlayerTeleported: CodeNode = {
  ...
  description: 'プレイヤーがテレポートしたとき発火する',
  icon: 'bolt',
  defaultStyle: STYLE,
  completionOutputs: [],
  inputs: {
...
export const OnPlayerTitle: CodeNode = {
  ...
  description: 'プレイヤーがタイトルメッセージを送信したとき発火する',
  icon: 'bolt',
  defaultStyle: STYLE,
  completionOutputs: [],
  inputs: {
...
export const OnPlayerMessage: CodeNode = {
  ...
  description: 'プレイヤーがメッセージを送信したとき発火する',
  icon: 'bolt',
  defaultStyle: STYLE,
  completionOutputs: [],
  inputs: {
...
export const OnPlayerBounced: CodeNode = {
  ...
  description: 'プレイヤーがスライムブロックなどでバウンスしたとき発火する',
  icon: 'bolt',
  defaultStyle: STYLE,
  completionOutputs: [],
  inputs: {
...
export const OnPlayerTransform: CodeNode = {
  ...
  description: 'プレイヤーの座標・向きが変化したとき発火する',
  icon: 'bolt',
  defaultStyle: STYLE,
  completionOutputs: [],
  inputs: {
