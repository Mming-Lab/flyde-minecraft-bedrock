...
export const BroadcastCommand = ln(cmdGameplay.BroadcastCommand,  n.BroadcastCommand)
export const BroadcastMessage = ln(cmdGameplay.BroadcastMessage,  n.BroadcastMessage)
...
export const AddPlayerLevel       = ln(cmdPlayer.AddPlayerLevel,       n.AddPlayerLevel)
export const SetGameMode          = ln(cmdPlayer.SetGameMode,          n.SetGameMode)
export const UpdateAbility        = ln(cmdPlayer.UpdateAbility,        n.UpdateAbility)
export const SetTitle             = ln(cmdPlayer.SetTitle,             n.SetTitle)
export const SetActionBar         = ln(cmdPlayer.SetActionBar,         n.SetActionBar)
export const ClearTitle           = ln(cmdPlayer.ClearTitle,           n.ClearTitle)
