...
export const ブロック破壊: CodeNode = {
  ...
  outputs: {
    ...
    O_ｱｲﾃﾑ: { description: '【null許容】ItemStack オブジェクト（破壊前に持っていたアイテム）。素手のとき null → Conditional(EXISTS)で分岐' },
  },
...
export const ブロック設置イベント: CodeNode = {
  ...
  outputs: {
    ...
    O_ｱｲﾃﾑ: { description: 'ItemStack オブジェクト（設置前に持っていたアイテム）→ ItemStack情報取得ノードへ' },
  },
